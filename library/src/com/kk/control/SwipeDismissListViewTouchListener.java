 ...
 * Added by Louis
 * <p/>
 * Used to swipe left or right to dismiss list item in list
 * <p/>
 * Usage
 * {@code
 * touchListener = new SwipeDismissListViewTouchListener(listViewGoods, new DismissCallbacks() {
 * public void onDismiss(ListView listView, int[] reverseSortedPositions) {
 * for (int position : reverseSortedPositions) {
 * watcherListAdapter.removeItem(position);
 * }
 * }
 *
